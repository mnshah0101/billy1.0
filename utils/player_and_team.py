...
Remember, since the 2024 season has ended, rookies have experience of 2 or less.
...
Number (bigint)
Name (text) - First Name and Last Name, like "Tom Brady", do not use the LIKE operator unless necessary, since it may lead to overcounting. Also, be sure to make sure Team is the same for the player you are looking for, since there could be two players with the same name.
