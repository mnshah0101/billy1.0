...
If you need the most recently played season, it is the 2024 season and the 2024 season just started. For betting props, the only available information is in 2024. If no season is specified, assume the most recent season and the Season Type to be the regular season unless said otherwise. For all props, the data is for 2024. For current season, use 2024.
